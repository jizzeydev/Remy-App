...
import { LayoutDashboard, BookOpen, ClipboardList, Users, LogOut, DollarSign, Building2, Moon, Sun, Trash2, GraduationCap } from 'lucide-react';
...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { icon: GraduationCap, label: 'Splits', path: '/admin/splits' },
